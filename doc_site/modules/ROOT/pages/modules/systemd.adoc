...
| systemd-cryptsetup
| https://www.freedesktop.org/software/systemd/man/latest/systemd-cryptsetup@.service.html[systemd-cryptsetup]
...
| systemd-pcrextend
| https://www.freedesktop.org/software/systemd/man/systemd-pcrextend.html[systemd-pcrextend]
