...
test_setup() {
    ...
    (
        ...
        inst_simple "${PKGLIBDIR}/modules.d/80base/dracut-lib.sh" "/lib/dracut-lib.sh"
        inst_simple "${PKGLIBDIR}/modules.d/80base/dracut-dev-lib.sh" "/lib/dracut-dev-lib.sh"
        ...
        inst_simple "${PKGLIBDIR}/modules.d/74nfs/nfs-lib.sh" "/lib/nfs-lib.sh"
