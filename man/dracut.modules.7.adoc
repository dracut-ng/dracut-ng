...
==== inst_sysusers <sysuserconf> [ <sysuserconf> ...]

installs one or more sysuser config files. Non-existent sysuser config files
are reported, but do not let dracut fail.
